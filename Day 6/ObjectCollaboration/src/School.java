public class School {
    ...
    public static void main(String[] args) {
        ...
        Subject subject = new Subject("Math", "English", "Hindi", "SSC");

        Student student = new Student("Shivansh", 22, "12th Grade", subject);

        School school = new School("Pushpa School", student, subject);
